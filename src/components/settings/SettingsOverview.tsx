...
export function SettingsOverview({ templates, stores, onTemplateSettingsOpen, onStoreSettingsOpen }: SettingsOverviewProps) {
    ...
    <>
      ...
      <div className="settings-overview-layout">
        ...
        <aside className="settings-side-panel">
          <section><h2>빠른 작업</h2><button type="button" onClick={onTemplateSettingsOpen}><span className="purple"><SettingsIcon name="clock" /></span>시간대 설정<i>›</i></button><button type="button" onClick={onStoreSettingsOpen}><span className="blue"><SettingsIcon name="building" /></span>근무지 추가<i>›</i></button><button type="button"><span className="green"><SettingsIcon name="users" /></span>직원 초대<i>›</i></button><button type="button"><span className="orange"><SettingsIcon name="bell" /></span>알림 설정<i>›</i></button></section>
